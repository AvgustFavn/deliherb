...
def downloadxml():
    try:
        with Session(engine) as session:
            ...
            xml_str = ET.tostring(data, encoding='utf8', xml_declaration=False)

            # Создаем HTTP-ответ с нужной кодировкой
            resp = Response(xml_str, mimetype='text/xml; charset=utf-8')
